...
class ScreenHelpTutorial06AddRaster extends PantherComponent {
	...
	onHelpLinkClick(helpScreenKey) {
		...
		if (component) {
			...
			logger.error("ScreenHelpTutorial06AddRaster# onHelpLinkClick(), Unknown help screen.", helpScreenKey);
		}
	}
			...
			<div>
				<div className="screen-content-only help-page"><div>
					...
					<iframe
						...
						width="720"
						height="421"
						src="https://www.youtube.com/embed/HfZSbIKNg_0?rel=0&cc_load_policy=1&cc_lang_pref=en"
						frameBorder="0"
						allowFullScreen
					></iframe>
					...
					<iframe
						...
						width="720"
						height="421"
						src="https://www.youtube.com/embed/8zhTOZb8rCU?rel=0&cc_load_policy=1&cc_lang_pref=en"
						frameBorder="0"
						allowFullScreen
					></iframe>
...
export default ScreenHelpTutorial06AddRaster;
